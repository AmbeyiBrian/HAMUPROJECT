...
class CustomTokenObtainPairSerializer(TokenObtainPairSerializer):
    """
    Custom JWT token serializer that adds user_class to the token payload
    """
    @classmethod
    def get_token(cls, user):
        ...
        # Add custom claims
        token['user_class'] = user.user_class
        token['name'] = user.names
        token['shop_id'] = user.shop_id if user.shop_id else None
