...
export default function MeterReadingsHistoryScreen() {  const { shop } = useLocalSearchParams();
      ...
      {showFilters && (
        <Card style={styles.filterPanel}>
          <Card.Content>
                ...
                <View style={styles.radioGroup}>
                  {readingTypes.map(type => (
                    <View key={type} style={styles.radioItem}>
                      <RadioButton.Android value={type} color="#e67e22" />
                      <Text>{type}</Text>
                    </View>
                  ))}
                  <View style={styles.radioItem}>
                    <RadioButton.Android value="" color="#e67e22" />
                    <Text>All Types</Text>
                  </View>
                </View>
              </RadioButton.Group>
            ...
            <View style={styles.filterRow}>
              <Text style={styles.filterLabel}>Reading Value:</Text>
